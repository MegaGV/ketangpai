    ...
    <div class="homework_page">
        <div class="homework_list">
            ...
            <el-dialog :visible.sync="new_homework_visible" width="30%">
                <el-form ref="new_homework" :model="new_homework">
                    <el-form-item>
                        <el-input v-model="new_homework.name" placeholder="课程名称"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-input type="textarea" :rows="3" v-model="new_homework.introduce" placeholder="作业简介，作业格式等要求"></el-input>
                    </el-form-item>
                ...
                <el-button type="primary">发布个人作业</el-button>
            </el-dialog>
            ...
            <div class="homework_box" v-for="homework in homeworks" :key="homework.id">
                ...
                <div>
                    ...
                    <div style="float:right">
                        ...
                        <span style="font-size:30px;position:relative;bottom:30px">{{parseInt(homework.uploaded)}}</span>
                        <span style="font-size:20px;position:relative;right:35px">已交</span>
                    </div>
...
export default {
    data(){
        return{
            homeworks:[
                {id: "001", name:"实验1", introduce:"提交demo1", starttime:"2019-12-16 16:09:33", endtime:"2019-12-22 16:09:36", reviewed:"0",uploaded:"1"},
            ],
            new_homework:{
                name:"",
                introduce:"",
